...
exports.VerificationEmailHtml = void 0;
...
var EmailTemplate = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Your one stop destination to build your Dream PC"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/email.jpg"), width: "150", height: "150", alt: "Chipcharm", style: logo }),
                React.createElement(components_1.Text, { style: paragraph }, "Hi there,"),
                React.createElement(components_1.Text, { style: paragraph },
                    "Welcome to Chipcharm! Your one stop destination to build your Dream PC. Use the button below to ",
                    actionLabel,
                    "."),
...
var VerificationEmailHtml = function (props) {
    return (0, components_1.render)(React.createElement(EmailTemplate, __assign({}, props)), {
        pretty: true,
    });
};
