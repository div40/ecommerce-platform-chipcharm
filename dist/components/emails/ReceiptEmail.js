...
var ReceiptEmail = function (_a) {
    ...
    var totalPrice = products.reduce(function (acc, curr) { return acc + curr.price; }, 0) + 10;
    return (React.createElement(components_1.Html, null,
        React.createElement(components_1.Head, null),
        React.createElement(components_1.Preview, null, "Your Order Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/email-sent.jpg"), width: "100", height: "100", alt: "ChipCharm" })),
                ...
                React.createElement(components_1.Section, { align: "right" },
                    ...
                    React.createElement(components_1.Column, { style: productPriceLargeWrapper },
                        React.createElement(components_1.Text, { style: productPriceLarge }, (0, utils_1.formatPrice)(totalPrice)))),
